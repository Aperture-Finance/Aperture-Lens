...
pub mod mock_erc721 {
    ...
    impl<M: ::ethers::providers::Middleware> MockERC721<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MockERC721Events> {
    ...
    pub struct IsApprovedForAllCall(pub ::ethers::core::types::Address, pub ::ethers::core::types::Address);
