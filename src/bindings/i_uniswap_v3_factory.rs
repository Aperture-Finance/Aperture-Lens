...
pub mod i_uniswap_v3_factory {
    ...
    impl<M: ::ethers::providers::Middleware> IUniswapV3Factory<M> {
        ...
        pub fn fee_amount_tick_spacing(&self, fee: u32) -> ::ethers::contract::builders::ContractCall<M, i32> {
            self.0
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IUniswapV3FactoryEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IUniswapV3Factory<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for IUniswapV3FactoryCalls {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            ...
            if let Ok(decoded) = <EnableFeeAmountCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::EnableFeeAmount(decoded));
            }
            if let Ok(decoded) = <FeeAmountTickSpacingCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for IUniswapV3FactoryCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::FeeAmountTickSpacing(element) => ::ethers::core::abi::AbiEncode::encode(element),
