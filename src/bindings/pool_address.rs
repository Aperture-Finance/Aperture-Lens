...
pub mod pool_address {
    ...
    pub static POOLADDRESS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static POOLADDRESS_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static POOLADDRESS_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for PoolAddress<M> {
