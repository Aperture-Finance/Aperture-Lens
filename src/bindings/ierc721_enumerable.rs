...
pub mod ierc721_enumerable {
    ...
    impl<M: ::ethers::providers::Middleware> IERC721Enumerable<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC721EnumerableEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IERC721Enumerable<M> {
