...
pub mod mock_erc20 {
    ...
    impl<M: ::ethers::providers::Middleware> MockERC20<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MockERC20Events> {
