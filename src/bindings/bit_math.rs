...
pub mod bit_math {
    ...
    pub static BITMATH_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    #[rustfmt::skip]
    ...
    pub static BITMATH_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(__BYTECODE);
    #[rustfmt::skip]
    ...
    impl<M: ::ethers::providers::Middleware> BitMath<M> {
        ...
        > {
            let factory =
                ::ethers::contract::ContractFactory::new(BITMATH_ABI.clone(), BITMATH_BYTECODE.clone().into(), client);
