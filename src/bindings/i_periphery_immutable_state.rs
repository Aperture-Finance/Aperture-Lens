...
pub mod i_periphery_immutable_state {
    ...
    pub static IPERIPHERYIMMUTABLESTATE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IPeripheryImmutableState<M> {
