...
pub mod i_uniswap_v3_mint_callback {
    ...
    impl<M> ::core::ops::Deref for IUniswapV3MintCallback<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IUniswapV3MintCallback<M> {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IUniswapV3MintCallback<M> {
    ...
    #[ethcall(name = "uniswapV3MintCallback", abi = "uniswapV3MintCallback(uint256,uint256,bytes)")]
