...
pub mod i_uniswap_v3_pool_immutables {
    ...
    impl<M> ::core::fmt::Debug for IUniswapV3PoolImmutables<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IUniswapV3PoolImmutables))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IUniswapV3PoolImmutables<M> {
    ...
    impl ::core::convert::From<MaxLiquidityPerTickCall> for IUniswapV3PoolImmutablesCalls {
