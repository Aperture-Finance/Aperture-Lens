...
pub mod i_uniswap_v3_pool_events {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IUniswapV3PoolEvents<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IUniswapV3PoolEventsEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            ...
            if let Ok(decoded) = IncreaseObservationCardinalityNextFilter::decode_log(log) {
                return Ok(IUniswapV3PoolEventsEvents::IncreaseObservationCardinalityNextFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<IncreaseObservationCardinalityNextFilter> for IUniswapV3PoolEventsEvents {
