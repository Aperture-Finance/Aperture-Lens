...
pub mod ierc20 {
    ...
    pub static IERC20_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    ...
    impl<M: ::ethers::providers::Middleware> IERC20<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC20Events> {
