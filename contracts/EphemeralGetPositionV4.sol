...
contract EphemeralGetPositionV4 is PositionUtilsV4 {
    ...
    /// @param positionManagerAddr UniV4's position manager contract address
    /// @param tokenId Token ID of the position
    function getPosition(address positionManagerAddr, uint256 tokenId) public payable returns (PositionState memory state) {
