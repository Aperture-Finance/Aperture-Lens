...
/// @notice A lens for Uniswap v4 that peeks into the current state of positions and pool info without deployment
...
contract EphemeralGetPositionsV4 is PositionUtilsV4 {
    ...
    /// @param positionManagerAddr The address of UniV4 position manager
